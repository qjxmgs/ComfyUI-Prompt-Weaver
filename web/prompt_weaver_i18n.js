const CHINESE_MESSAGES = Object.freeze({
    ...
    "Enable All": "全开",
    "Disable All": "全关",
    "Enable all cards": "全部开启卡片",
    "Disable all cards": "全部关闭卡片",
    "Some cards are enabled. Activate to enable all cards": "部分卡片已开启，点击后将全部开启",
    "No cards to toggle": "没有可切换的卡片",
    ...
    "Add Favorite Card": "收藏卡片添加",
    "Import": "导入",
    "Import favorite cards from text": "从文本导入收藏卡片",
    "Import Favorite Cards": "导入收藏卡片",
    "Close favorite card import": "关闭收藏卡片导入窗口",
    "Target secondary category": "目标二级分类",
    "No secondary categories available": "没有可用的二级分类",
    "Create a secondary category before importing favorite cards.": "请先新建二级分类再导入收藏卡片。",
    "Paste alternating title and prompt lines": "粘贴交替排列的标题行和提示词行",
    "Card title\nprompt text\n\nAnother title\nanother prompt": "卡片标题\n提示词文本\n\n另一个标题\n另一个提示词",
    "Favorite cards import text": "收藏卡片导入文本",
    "Preview": "预览",
    "Confirm Import": "确认导入",
    "Title exceeds 200 characters.": "标题超过 200 个字符。",
    "Prompt exceeds 100,000 characters.": "提示词超过 100,000 个字符。",
    "Prompt cannot be empty.": "提示词不能为空。",
    "Import text cannot exceed 512 KiB.": "导入文本不能超过 512 KiB。",
    "{ready} cards ready; {skipped} entries will be skipped.": "可导入 {ready} 张卡片；将跳过 {skipped} 个条目。",
    "Ignored because no prompt line follows this title.": "已忽略：该标题后没有对应的提示词行。",
    "No favorite cards could be imported.": "没有可导入的收藏卡片。",
    "Imported {imported} favorite cards; skipped {skipped}.": "已导入 {imported} 张收藏卡片；跳过 {skipped} 个条目。",
    ...
    "Drag to reorder; right-click for category actions": "拖拽调整顺序；右键打开分类菜单",
    "Category order updated.": "分类顺序已更新。",
    "Category moved to {name}.": "分类已移动到{name}。",
    ...
    "Move Up": "上移",
    "Move Down": "下移",
    "Favorite order updated.": "收藏顺序已更新。",
    "Resize Favorite Cards": "调整收藏卡片窗口大小",
    "Drop here to place the favorite first.": "拖到此处可将收藏放在第一位。",
    "Remove": "移除",
    "Choose a destination secondary category.": "请选择目标二级分类。",
    "Favorite actions": "收藏操作",
    "Right-click for favorite actions": "右键打开收藏菜单",
    "Favorite card title": "收藏卡片标题",
    "Favorite card title cannot be empty.": "收藏卡片标题不能为空。",
    "Favorite card title is too long.": "收藏卡片标题过长。",
    "Favorite renamed.": "收藏已重命名。",
    ...
    "All Enabled": "已全开",
    "All Disabled": "已全关",
    "Partially Enabled": "部分开启",
    "No Prompts": "无提示词",
    "No prompts to toggle": "没有可切换的提示词",
    "Some prompts are enabled. Activate to enable all prompts": "部分提示词已开启，点击后将全部开启",
    "Bulk selection is unavailable in Text Mode": "文本模式下无法批量切换",
