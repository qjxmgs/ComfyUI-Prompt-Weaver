const CHINESE_MESSAGES = Object.freeze({
    ...
    "Copy failed": "复制失败",
    "Favorites": "收藏",
    "Open prompt card favorites": "打开提示词卡片收藏",
    "Save or manage this card's favorite": "保存或管理当前卡片收藏",
    "Switch this card to a favorite": "将当前卡片切换为收藏卡片",
    "Prompt Card Favorites": "提示词卡片收藏",
    "Close prompt card favorites": "关闭提示词卡片收藏",
    "Loading favorites…": "正在加载收藏…",
    "Retry": "重试",
    "Prompt card library data is invalid.": "提示词卡片收藏数据无效。",
    "Prompt card library request failed (HTTP {status})": "提示词卡片收藏请求失败（HTTP {status}）",
